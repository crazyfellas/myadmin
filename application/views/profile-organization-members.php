...
<?php 
	...
	if($_SESSION['system_access_lvl'] == 1){
		$q_members = $this->db->query("select * from members where org_chapter ='".$org_code."'");
	}
	elseif($_SESSION['system_access_lvl'] == 4){
		...
		$q_members = $this->db->query("select * from members where muncity_code ='".$_SESSION['muncity']."' and is_active = 'TRUE' and member_grp = 1");
	}
?>
<h4>Organization Farmer's Profile</h4>
<hr/>
<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
	...
	<tbody>
		...
		<tr>
			<td><a href="update-client-register?user_code=<?php echo $member->user_code ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> <?php echo $member->user_code ?></a></td>
			...
			<td><?php echo $member->org_chapter ?></td>
